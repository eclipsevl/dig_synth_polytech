set log file fv/sram/rtl_to_g1.log -replace
...
usage -auto -elapse
// tclmode
// set env(CDN_SYNTH_ROOT) /tools/cadence/EDI131/tools
// vpxmode

tclmode
puts "Start: Reading OVF file"
vpx read guide file fv/sram/rtl_to_g1.ovf
...
add search path -library /design/UMC65nm_SP_lowK_IP/_G-01-LOGIC_MIXED_MODE65N-SP_LOW_K_UMC-IP/G-9LT-LOGIC_MIXED_MODE65N-SP_LOW_K_UMK65LSCSPMVBBR-LIBRARY_TAPE_OUT_KIT-Ver.B01_P.B/synopsys
read library -statetable -liberty -both  \
	uk65lscspmvbbr_100c25_tc.lib

add search path -design .
read design  -verilog2k -define SYNTHESIS  -golden -lastmod -noelab \
	../RTL/sram.v

elaborate design -golden -root sram -rootonly \

read design -verilog -revised -lastmod -noelab \
	-unzip fv/sram/g1.v.gz

elaborate design -revised -root sram
